...
export function contentAllocationRoleWizard(
...
function createAllocationRoleAction(parent: Element): WizardActor {
  return (inputs: WizardInputElement[]): Edit[] => {
    const AllocationRoleAttrs: Record<string, string | null> = {};
    ...
    const AllocationRoleNode = createElement(
...
export function createAllocationRoleWizard(parent: Element): Wizard {
  const name = null;
  const desc = null;
...
function updateAllocationRole(element: Element): WizardActor {
  return (inputs: WizardInputElement[]): Edit[] => {
...
export function editAllocationRoleWizard(element: Element): Wizard {
